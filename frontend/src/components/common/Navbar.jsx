...
const Navbar = () => {
    ...
    return (
        <nav className={`z-[10] flex h-14 w-full items-center justify-center border-b-[1px] 
            border-b-richblack-700 text-white translate-y-0 transition-all ${showNavbar}`}>
            ...
            <div className='flex w-11/12 max-w-maxContent items-center justify-between'>
                ...
                <ul className='hidden sm:flex gap-x-6 text-richblack-25'>
                        ...
                        <li key={index}>
                            {link.title === "Catalog" ? (
                                ...
                                >
                                    ...
                                    >
                                        <div className="absolute left-[50%] top-0 z-[100] h-6 w-6 
                    ...
                    <li>
                        <Link to="/ai-generator">
                            <p className={`${matchRoute('/ai-generator') ? "bg-yellow-25 text-black" : "text-richblack-25"} 
                                rounded-xl p-1 px-3`}>
                                Assignments & <br/>
                                AI QuestionPaper
                            </p>
                    ...
                    {/* <li>
                        <Link to="/assignments">
                            <p className={`${matchRoute('/assignments') ? "bg-yellow-25 text-black" : "text-richblack-25"} 
                                rounded-xl p-1 px-3`}>
                                Assignments
                            </p>
                        </Link>
                    ...
                    <li>
                        <Link to="/quiz">
                            <p className={`${matchRoute('/quiz') ? "bg-yellow-25 text-black" : "text-richblack-25"} 
                                rounded-xl p-1 px-3`}>
                                Quizzes
                            </p>
                        </Link>
                ...
                {/* Login / Signup / Dashboard Section */}
                <div className='flex gap-x-4 items-center'>
                    {user && user?.accountType === "Student" && (
                        <Link to="/dashboard/cart" className="relative">
                            <AiOutlineShoppingCart className="text-[2.35rem] text-richblack-5 
                                hover:bg-richblack-700 rounded-full p-2 duration-200" />
                            {totalItems > 0 && (
                                <span className="absolute -bottom-2 -right-2 grid h-5 w-5 place-items-center 
                                    overflow-hidden rounded-full bg-richblack-600 text-center text-xs 
